...
Which certainly equals $2\cdot 3+3\cdot 2$. And, to show-off, here's a mixed partial derivative:
...
Finally, the mixed derivative $\text{d}^2z/\text{d}x\text{d}y$ of our running example is:
...
```python
# our own automatic differentiation library!
# download from https://e-dorigatti.github.io/attachments/autodiff.py
